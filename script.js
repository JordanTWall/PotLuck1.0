const chefs = {
      "kaitlynWall": {
        "firstName": "Kaitlyn",
        "lastName": "Wall",
        "blurb": "Amazing wife and excellent home chef. Favorite recipes include chicken pot pie and Jordan's Homemade Marguaritas",
        "avatar": "",
        "dishes": {
          "dish1": {
            "dishName": "German Potato Salad",
            "dishChefNotes": "A twist on the beloved British favorite, delightfully simple and absolutely delicious for breakfast, brunch, lunch, or even dinner.",
            "dishIngredients": [
              ...
              "1/3 cup chopped fresh herbs (I like chives & parsley)"
            ],
            "dishRecipe": [
              ...
              "Stir it in with the onions and bacon and let it reduce, about 2 min. Stir in the chicken broth, mustard, salt, and pepper, and turn off the heat. Slice the cooled potatoes about 14 inch thick.",
              "Stir the potatoes and herbs into the warm dressing. Stir until the potatoes are coated evenly. Enjoy!"
            ],
            "dishImg": "https://www.gordonramsay.com/assets/Uploads/_resampled/CroppedFocusedImage90045050-50-Mushroomtoast.jpg"
          }
        }
      },
      "jordanWall": {
        "firstName": "Jordan",
        "lastName": "Wall",
        "blurb": "Amateur chef and front end developer. Jordan will be the greatest software engineer since mark zuckerberg. He will develop the whole web all by himself.",
        "avatar": "",
        "dishes": {
          "dish1": {
            "dishName": "Jord’s Margs",
            "dishChefNotes": "Because you’re using fresh fruit, you can get away with pretty darn cheap tequila. I recommend Jimmy Buffet’s margaritaville ($25 for 1.75L). ",
            "dishIngredients": [
              "750 ml tequila",
              "500 ml triple sec",
              "7 limes, halved",
          ...
          "dish2": {
            ...
            "dishChefNotes": "I don't think this dish belongs to any asian cuisine. I just made it using everything I have in my fridge",
            "dishIngredients": [
              "2 onions sliced",
